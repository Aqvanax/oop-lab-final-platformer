...
public class Game {
    ...
    /*
     * Game loop chạy trên background thread.
     * Gọi repaint() theo chuẩn AWT — thread-safe, không qua Swing Timer.
     * CheerpJ route repaint qua AWT event queue bình thường.
     */
